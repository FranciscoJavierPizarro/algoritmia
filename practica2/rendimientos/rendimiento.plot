...
"./rendimientoHaskSimulado.txt" with lines title 'Haskell Simulado' linestyle 2 linecolor rgb "blue", \
"./rendimientoHaskDirecto.txt" with lines title 'Haskell Directo' linestyle 3 linecolor rgb "green"
