...
set multiplot
plot "./precalcMod.txt" with lines title 'Precalculado' linestyle 1 linecolor rgb "red", \
"./pdonflyMod.txt" with lines title 'Al vuelo' linestyle 2 linecolor rgb "blue", \
